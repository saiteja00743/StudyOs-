...
import { Plus, MessageSquare, Trash2, Edit3, Sparkles } from 'lucide-react';
...
export function ChatSidebar({
  ...
  return (
    <div className="w-64 glass border-r border-white/5 flex flex-col h-full flex-shrink-0 hidden md:flex">
      {/* Header & New Chat button */}
      <div className="p-4 border-b border-white/5 space-y-3">
        <button
          onClick={onNewChat}
          className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-brand-gradient hover:opacity-90 transition-all text-white font-medium text-sm shadow-glow-sm group"
        >
